    ...
    <script src='../static/js/general.js?v=1.9' async></script>
    ...
    <script src='../static/js/ajax_calidad.js?v=1.9' async></script>
    <script src='../static/js/ajax_pruebas.js?v=1.9' async></script>
